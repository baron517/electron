...
function jihuo()
{
	if((!localStorage.start_time)||(localStorage.start_time>=localStorage.end_time))
	{
		...
		{
			//console.log("start:"+localStorage.start_time);
			localStorage.start_time=parseInt(localStorage.start_time)+5;
		}
